...
void run_hedonic_CPM(const igraph_t *graph, const igraph_vector_t *edge_weights, const igraph_real_t resolution_parameter) {
...
void run_hedonic_modularity(igraph_t *graph, igraph_vector_t *edge_weights) {
...
int main(void) {
    ...
    igraph_small(&graph, 0, IGRAPH_UNDIRECTED,
                 ...
                 -1);
    run_hedonic_modularity(&graph, NULL);
    run_hedonic_CPM(&graph, NULL, 0.06);
    igraph_destroy(&graph);
    ...
    run_hedonic_modularity(&graph, NULL);
    run_hedonic_CPM(&graph, NULL, 0.05);
    igraph_destroy(&graph);
    ...
    run_hedonic_CPM(&graph, NULL, 0.4);
    igraph_destroy(&graph);
