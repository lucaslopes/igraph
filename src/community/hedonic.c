 ...
 * C, C + 1, ..., C' - 1.
 */
static igraph_error_t igraph_i_community_hedonic_clean_refined_membership(
 ...
 * igraph_i_community_hedonic_clean_refined_membership for more information about
 * this aspect.
 */
static igraph_error_t igraph_i_community_hedonic_mergenodes(
        const igraph_t *graph,
        const igraph_inclist_t *edges_per_node,
        const igraph_vector_t *edge_weights, const igraph_vector_t *node_weights,
        const igraph_vector_int_t *node_subset,
    ...
    IGRAPH_CHECK(igraph_i_community_hedonic_clean_refined_membership(node_subset, refined_membership, nb_refined_clusters));
 ...
 *
 */
static igraph_error_t igraph_i_community_hedonic_aggregate(
