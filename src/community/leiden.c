 ...
 * Only moves that improve the quality by more than the numerical convergence
 * margin are considered; smaller improvements are treated as ties.
 *
 ...
 *    isolated community or cover membership.
 ...
 * isolation moves. This computes the best response in
